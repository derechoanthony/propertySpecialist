<div id="section3" class="{{ $property->slct_propertyType == 'commercial'? 'show' : 'hidden'}}">
    <div class="row my-4">
        <div class="col-lg-12">
        ...
        <div class="col-lg-5">
            <div class="form-group">
                ...
                <input type="text" name="txt_com_bedrooms" maxlength="10" value="{{ $property->txt_com_bedrooms }}" data-bv-integer="true" class="form-control" onkeypress="return isNumber(event)" placeholder="Please input number of bedrooms...">
        ...
        <div class="col-lg-5">
            <div class="form-group">
                ...
                <input type="text" name="txt_com_bathrooms" maxlength="10" value="{{ $property->txt_com_bathrooms }}" data-bv-integer="true" class="form-control" onkeypress="return isNumber(event)" placeholder="Please input number of bathrooms...">
        ...
        <div class="col-lg-5">
            <div class="form-group">
                ...
                <input type="text" name="txt_com_totalrooms" maxlength="10" value="{{ $property->txt_com_totalrooms }}" data-bv-integer="true" class="form-control" onkeypress="return isNumber(event)" placeholder="Please input total rooms...">
    ...
    <div class="row propertydetail">
        <div class="col-lg-5">
            <div class="form-group">
                ...
                <input type="text" name="txt_com_flrarea" maxlength="10" value="{{ $property->txt_com_flrarea }}" data-bv-integer="true" class="form-control" onkeypress="return isNumber(event)" placeholder="Please input floor area...">
        ...
        <div class="col-lg-5">
            <div class="form-group">
                ...
                <input type="text" name="txt_com_flrtotal" maxlength="10" value="{{ $property->txt_com_flrtotal }}" data-bv-integer="true" class="form-control" onkeypress="return isNumber(event)" placeholder="Please input floor total...">
        ...
        <div class="col-lg-5">
            <div class="form-group">
                ...
                <input type="text" name="txt_com_carspace" maxlength="10" value="{{ $property->txt_com_carspace }}" data-bv-integer="true" class="form-control" onkeypress="return isNumber(event)" placeholder="Please input car space...">
        ...
        <div class="col-lg-5">
            <div class="form-group">
                ...
                <select class="yearselect form-control" name="slct_com_yearbuilt">
